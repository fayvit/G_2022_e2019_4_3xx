...
{
    public static class TextosDeBarreirasPT_BR
    {
        public static Dictionary<TextKey, List<string>> txt = new Dictionary<TextKey, List<string>>()
    {
        {TextKey.barreirasDeGolpes, new List<string>()
        {
            ...
            "Está pegando fogo bicho!!",
            "É uma barreira feita de uma madeira bem seca",
            "Uma grade de arame bem fino. Uma boa lâmina talvez possa corta-la",
            "Nossa!! Isso é coco! Alguém precisa enterrar isso",
            ...
            /*ID=8*/
            "Isso me lembra uma musica que dizia algo sobre \" Pedrada na vidraça...\"",
