...
{
    [System.Serializable]
    public class SprayToxico : SimpleAreaAttack
    {
        public SprayToxico() : base(new PetAttackFeatures()
        {
        ...
        })
        {
            feat = new AreaFeatures
            {
                ...
                prepara = GeneralParticles.preparaAtkDeGas,
                damageParticle = GeneralParticles.gasAoChao,
