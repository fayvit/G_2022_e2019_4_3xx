...
namespace Criatures2021
{
    public class CheckPushBlockPuzzle:MonoBehaviour
    {
        ...
        {
            Debug.Log(AbstractGlobalController.Instance.Players[0].Manager.transform);
            Debug.Log(GetComponentInChildren<TriggerReturnToStandardCam>().transform);
            CharacterController cc =
            AbstractGlobalController.Instance.Players[0].Manager.transform.GetComponent<CharacterController>();
            cc.enabled = false;
        ...
        void CheckProcedure()
        {
            ...
            {
                oMovimentado = AbstractGlobalController.Instance.Players[0].Manager.transform.gameObject
            });
        ...
        {
            Debug.Log("ja chegou o disco voador");
