...
{
    public class InEditorSupportSingleton : MonoBehaviour
    {
        //private Dictionary<string, System.Action> schelduleActions = new Dictionary<string, System.Action>();
        private static InEditorSupportSingleton instance;

        public static InEditorSupportSingleton Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    G.name = "Fayvit_InEditorSupportSingleton";

                    instance = G.AddComponent<InEditorSupportSingleton>();
                }
        ...
        void Start()
        {
            InEditorSupportSingleton[] g = FindObjectsOfType<InEditorSupportSingleton>();
